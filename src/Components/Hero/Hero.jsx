    ...
    <div className="landing">
      <div className="max-w-screen-xl mx-auto px-4 py-16 flex flex-col lg:flex-row items-center justify-between gap-12 w-full">
        ...
        <div className="flex-1 max-w-xl text-center lg:text-left animate-fade-in-up">
          ...
          >
            AI-powered recruitment platform that matches the right talent with
            the right job — faster, smarter, and bias-free.
          </p>

          <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
            <Link
              to="/register"
              className="btn-primary justify-center text-base px-7 py-3"
            >
              <svg
                width="18"
                height="18"
            ...
            <Link
              to="/register"
              className="btn-outline justify-center text-base px-7 py-3"
            >
              <svg
                width="18"
                height="18"
